...
import os
import sys
from swift.cli._megatron.main import cli_main

if __name__ == "__main__":
    # ====== Environment Variables (previously export) ======
    ...
    # ====== Command-line Arguments (previously shell args) ======
    sys.argv = [
        "megatron", "sft",
...
#===========the following is the original shell script for megatron sft training============#
